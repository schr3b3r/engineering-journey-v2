...
- [x] Canonical agent mode accepts a schema-validated overview plus exact per-period prose from the LLM already running the skill, then deterministically renders and publishes it without external model credentials.
