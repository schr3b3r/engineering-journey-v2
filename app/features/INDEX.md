...
|---|---|---|
| [m1_backfill_checkpoint.md](m1_backfill_checkpoint.md) | done | Completed source-time coverage durations plus bounded actual-time progress moments, idempotent replay, and legacy migration planning |
