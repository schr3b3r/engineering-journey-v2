...
|---|---|---|
| [m1_backfill_checkpoint.md](m1_backfill_checkpoint.md) | done | One run-level history coverage duration plus bounded operational run moments, fingerprint replay, and legacy migration |
